...
print(len(df)) # =170
print(len(df_IQR)) # =150

###########################################
## How good was our first-order guess to exclude densities above 20000 𝑘𝑔/𝑚3 ?
# It seems it was actually good! By printing the length of our first df and the new
# df_IQR they differ only in 22 planets. 
...
fig.savefig("Week_5_IQR.png", dpi=200)
