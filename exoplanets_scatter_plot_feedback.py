...
######## DR: The masses and radii you give to the function density here
######## are multiples of Earth's mass. But for calculating the density,
######## you need the masses and radii in SI units
